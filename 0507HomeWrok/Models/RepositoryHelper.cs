namespace _0507HomeWrok.Models
{
	public static class RepositoryHelper
	{
		...
		public static v_客戶資料關聯統計表Repository Getv_客戶資料關聯統計表Repository()
		{
			var repository = new v_客戶資料關聯統計表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static v_客戶資料關聯統計表Repository Getv_客戶資料關聯統計表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new v_客戶資料關聯統計表Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
